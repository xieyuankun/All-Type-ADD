...
if __name__ == "__main__":
    ...
    # print(summary(W2VAASIST(), torch.randn((128,64600)), show_input=False))
    ...
    model = WPTW2V2AASIST(model_dir="/data3/xyk/huggingface/wav2vec2-xls-r-300m/", prompt_dim=1024, num_prompt_tokens=6, num_wavelet_tokens=4).cuda()
    # model = PTW2V2AASIST(model_dir="/data3/xyk/huggingface/wav2vec2-xls-r-300m/", prompt_dim=1024, num_prompt_tokens=10, visual=False).cuda()
    feature = torch.randn((16,64600)).cuda()
    model = XLSRAASIST(model_dir="/data3/xyk/huggingface/wav2vec2-xls-r-300m/",freeze=True).cuda()
    # model = WAVLMAASIST(model_dir="/data3/xyk/huggingface/wavlm-large/").cuda()
    # model = MERTAASIST(model_dir="/data3/xyk/huggingface/MERT-300M/").cuda()
